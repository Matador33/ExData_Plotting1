plot1 <- function () {
  ...
  ## plot1
  ## Concern: the values in column 3 of the data seem to be in watts rather than kilowatts as stated
  ## Dividing the numbers by 1000 would look better on the graph but would be an untrue
  ## presentation of the data so I've not done it!!
  png(file="plot1.png")
